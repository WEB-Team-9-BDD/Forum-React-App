...
export default function CreateAccount() {
    ...
    const createUserProfile = async () => {
        const { username, email, password, firstName, lastName, isAdmin, phoneNumber, isBlocked,photoURL } = form;
        ...
        if (username.length === 0) {
            ...
            try {
                ...
                await createUser(username, firstName, lastName, email, userCredentials.user.uid, isAdmin, phoneNumber, isBlocked, photoURL)
